      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <li><hr class="dropdown-divider"></li>
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../admin/doctor-login.php">DOCTOR</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../admin/login-paitent.php">PATIENT</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="../admin/register-patient.php">REGISTER </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="../admin/contact-form.php">CONTACT US </a>
        </li>
      </ul>
